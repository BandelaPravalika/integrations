...
import com.universalsaas.platform.integrations.service.TenantContextHolder;
...
public class ApiKeyAuthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        try {
            ...
            response.getWriter().write(com.universalsaas.platform.integrations.util.JsonUtil.toJson(failure));
            return false;
        }
    }
