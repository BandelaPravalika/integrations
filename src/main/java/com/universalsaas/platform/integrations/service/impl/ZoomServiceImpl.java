...
import com.universalsaas.platform.integrations.repository.ExternalEventMappingRepository;
...
public class ZoomServiceImpl implements ZoomService {
    ...
    public OAuthConnectResponse buildConnectUrl() {
        ...
        String url = UriComponentsBuilder.fromHttpUrl("https://zoom.us/oauth/authorize")
